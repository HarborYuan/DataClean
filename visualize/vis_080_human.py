...
JSON_PATH = 'data/vid/080_refsav_human_part/annotations/annotation.json'
TASK_ID = 'vis080_refsav_human_part'
RATIO = .1
...
if __name__ == '__main__':
    ...
    for item in json_content:
        ...
        if flag:
            mmengine.put_text(item['input']['prompt'], os.path.join(out_folder, 'prompt.txt'))
            tot += 1
