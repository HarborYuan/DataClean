...
def vos_inference(
    ...
    for input_frame_idx in input_frame_inds:
        input_mask = maskUtils.decode(input_mask)
        per_obj_input_mask = {
            0: input_mask
        }
        # try:
    ...
    for out_frame_idx, out_obj_ids, out_mask_logits in predictor.propagate_in_video(
        ...
        per_obj_output_mask = (out_mask_logits[0] > score_thresh).cpu().numpy()
...
def main():
    ...
    for n_video, video_name in enumerate(video_names):
        ...
        input_mask = gt_list['0']['mask']
        video_segments = vos_inference(
            predictor=predictor,
            base_video_dir=base_video_path,
            input_mask=input_mask,
            output_mask_dir=args.video_list_folder,
            video_name=video_name,
