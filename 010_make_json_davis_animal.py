...
PATH = 'data/video_datas/davis17/meta_expressions/train/meta_expressions.json'
MASK_PATH = 'data/video_datas/davis17/train/mask_dict.pkl'
OUT_DIR = 'data/seg/010_davis_animal'

IMG_PREFIX = 'data/video_datas/davis17/train/JPEGImages'
